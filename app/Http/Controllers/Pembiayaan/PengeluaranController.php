...
class PengeluaranController extends Controller
{
    ...
    public function rincian(Request $request, $id_skpd)
    {
        ...
        return view('pembiayaan.pengeluaran.rincian.index', compact(
            'skpd',
            'id_skpd',
            'totalSetelah',
            'totalSebelum',
    ...
    public function store(Request $request, $id_skpd)
    {
        ...
        return redirect()
            ->route('pembiayaan.pengeluaran.rincian', $id_skpd)
            ->with('success', 'Data pembiayaan pengeluaran berhasil ditambahkan.');
    }
    ...
    public function edit($id_skpd, $id_pembiayaan)
    {
        ...
        return view('pembiayaan.pengeluaran.rincian.edit', compact(
            'skpd',
            'pembiayaan',
            'akunList',
            'id_skpd',
    ...
    public function update(Request $request, $id_skpd, $id)
    {
        ...
        return redirect()
            ->route('pembiayaan.pengeluaran.rincian', $id_skpd)
            ->with('success', 'Data pembiayaan pengeluaran berhasil diperbarui.');
    }
    ...
    public function destroy($id_skpd, $id)
    {
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Data pembiayaan pengeluaran berhasil dihapus.',
            ]);
        } catch (\Throwable $e) {
            return response()->json([
                'success' => false,
    ...
    public function bulkDelete(Request $request, $id_skpd)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => $count.' data pembiayaan pengeluaran berhasil dihapus.',
            ]);
        } catch (\Throwable $e) {
            return response()->json([
                'success' => false,
