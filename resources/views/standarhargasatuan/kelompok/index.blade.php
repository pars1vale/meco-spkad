...
@section('content')
  <x-toolbar title="Kelompok Satuan Harga" :breadcrumbs="[['label' => 'Home', 'url' => url('/')], ['label' => 'Standar Harga'], ['label' => 'Kelompok Satuan Harga']]" />
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input toggle-active" type="checkbox" value="{{ $item->id }}" {{ $item->active ? 'checked' : '' }}
                          data-id="{{ $item->id }}" />
