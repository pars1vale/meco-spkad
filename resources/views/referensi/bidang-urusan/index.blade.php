...
@section('content')
        ...
        <div class="card-header border-0 pt-6">
          ...
          <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
              ...
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_bidang_urusan">Tambah Bidang
                Urusan</button>
            </div>
            ...
            <table id="kt_bidang_urusan_table" class="table table-striped table-row-bordered gy-5 gs-7">
              ...
              <tbody class="fw-semibold text-gray-600">
                @foreach ($data as $urusanGroup)
                  ...
                  @foreach ($urusanGroup as $bidangUrusan)
                    <tr>
                      <td>
            ...
            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_bidang_urusan_scroll">
              ...
              <div class="fv-row mb-7">
                ...
                <input type="text" class="form-control form-control-solid @error('kode_bidang_urusan') is-invalid @enderror"
                  placeholder="Masukkan kode bidang urusan" name="kode_bidang_urusan" value="{{ old('kode_bidang_urusan') }}" maxlength="20"
                  required />
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      var table = $('#kt_bidang_urusan_table').DataTable({
        responsive: true,
        searchDelay: 500,
        processing: true,
        serverSide: false,
          ...
          api.column(3, {
            ...
            if (lastUrusan !== urusan) {
              $(rows[i]).before(
                ...
                '<td colspan="5" class="fw-bold fs-6 px-1 py-3">' + urusan + '</td></tr>'
              );
              lastUrusan = urusan;
            }
          });
      ...
      // Handle click on group headers to sort
      $('#kt_bidang_urusan_table').on('click', 'tr.group', function() {
      ...
      // === Bulk selection ===
      const checkboxes = document.querySelectorAll('#kt_bidang_urusan_table tbody input[type="checkbox"]');
      const masterCheckbox = document.querySelector('#kt_bidang_urusan_table thead input[type="checkbox"]');
      ...
      function updateToolbar() {
        const checkedBoxes = document.querySelectorAll('#kt_bidang_urusan_table tbody input[type="checkbox"]:checked');
      ...
      document.getElementById('bulk_delete_btn')?.addEventListener('click', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = '{{ route('bidang-urusan.bulk-delete') }}';
