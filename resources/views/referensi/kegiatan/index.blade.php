...
@section('content')
  <x-toolbar title="Kegiatan" :breadcrumbs="[['label' => 'Home', 'url' => url('/')], ['label' => 'Referensi'], ['label' => 'Kegiatan']]" />
        ...
        <div class="card-header border-0 pt-6">
          ...
          <div class="card-toolbar">
            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_kegiatan">
  ...
  @include('referensi.kegiatan.partials.modal-add')
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      ...
      var initDatatable = function() {
        dt = $("#kt_kegiatan_table").DataTable({
          searchDelay: 500,
          processing: true,
          serverSide: true,
          order: [
            ...
            [5, 'asc'],
            [1, 'asc']
          ], // Sort by urusan, bidang, program, then kode
          stateSave: false,
          ajax: {
            url: "{{ route('referensi.kegiatan.getData') }}",
            type: "GET",
          },
          columns: [{
              data: 'id',
          ...
          drawCallback: function(settings) {
            ...
            // Group by 3 levels: urusan (column 3), bidang urusan (column 4), program (column 5)
            api.column(3, {
              page: 'current'
              ...
              if (lastBidang !== bidang) {
                $(rows).eq(i).before(
                  ...
                  '<td colspan="7" class="fw-bold fs-6 px-4 py-3">' +
                  bidang +
                  '</td></tr>'
                );
                lastBidang = bidang;
      ...
      var handleGroupClick = function() {
        $('#kt_kegiatan_table').off('click', 'tr.group').on('click', 'tr.group', function() {
          var colIdx;
          ...
          button.addEventListener('click', function(e) {
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                ...
                form.method = 'POST';
                form.action = `{{ url('referensi/kegiatan') }}/${id}`;
      ...
      var initToggleToolbar = function() {
        const container = document.querySelector('#kt_kegiatan_table');
          ...
          deleteSelected.addEventListener('click', function() {
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                ...
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = '{{ route('referensi.kegiatan.bulk-delete') }}';
