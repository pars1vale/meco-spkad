<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    DOM.table = $('#kt_akun_table');
    DOM.searchInput = document.getElementById('kt_datatable_search_input');
    DOM.akunTypeSwitches = document.querySelectorAll('.akun-type-switch');
    DOM.tipeAkunError = document.getElementById('tipe-akun-error');
    DOM.addForm = document.getElementById('kt_modal_add_akun_form');
    DOM.addSubmitButton = document.getElementById('kt_modal_add_akun_submit');
    DOM.masterCheckbox = document.querySelector('#kt_akun_table thead input[type="checkbox"]');
    DOM.checkboxes = document.querySelectorAll('#kt_akun_table tbody input[type="checkbox"]');
      ...
      DOM.addForm.addEventListener('submit', function(e) {
        ...
        if (!hasTypeSelected) {
          ...
          Swal.fire({
            ...
            text: 'Anda harus memilih salah satu tipe akun!',
            confirmButtonText: 'OK',
            buttonsStyling: false,
            customClass: {
              confirmButton: "btn btn-primary"
