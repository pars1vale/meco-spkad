      ...
      <form action="{{ route('perangkat-daerah.update', $data->id) }}" method="POST">
        ...
        <div class="card-body">
          ...
          <div class="fv-row mb-7">
            ...
            <input type="text" 
                   class="form-control form-control-solid @error('nama_skpd') is-invalid @enderror"
                   placeholder="Masukkan Nama" 
                   name="nama_skpd" 
                   value="{{ old('nama_skpd', $data->nama_skpd) }}" 
                   maxlength="255"
                   required />
            @error('nama_skpd')
          ...
          <div class="fv-row mb-7">
            ...
            <input type="text" 
                   class="form-control form-control-solid @error('nipkepala') is-invalid @enderror"
                   placeholder="Masukkan NIP Kepala" 
                   name="nipkepala" 
                   value="{{ old('nipkepala', $data->nipkepala) }}" 
                   maxlength="255" />
            @error('nipkepala')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          ...
          <div class="fv-row mb-7">
            ...
            <input type="text" 
                   class="form-control form-control-solid @error('namakepala') is-invalid @enderror"
                   placeholder="Masukkan Nama Kepala" 
                   name="namakepala" 
                   value="{{ old('namakepala', $data->namakepala) }}" 
                   maxlength="255" />
            @error('namakepala')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          ...
          <div class="fv-row mb-7">
            ...
            <select class="form-select form-select-solid @error('pangkatkepala') is-invalid @enderror" 
                    name="pangkatkepala">
              <option value="">Pilih Pangkat</option>
              @foreach ($pangkat as $p)
                <option value="{{ $p->id }}" 
                        {{ old('pangkatkepala', $data->pangkatkepala) == $p->id ? 'selected' : '' }}>
                  {{ $p->nama }}
                </option>
              @endforeach
            </select>
          ...
          <div class="fv-row mb-7">
            ...
            <select class="form-select form-select-solid @error('statuskepala') is-invalid @enderror" 
                    name="statuskepala">
        ...
        <div class="card-footer d-flex justify-content-end gap-2">
          <a href="{{ route('pengaturan.perangkat-daerah.index') }}" 
             class="btn btn-light">
            Batal
          </a>
