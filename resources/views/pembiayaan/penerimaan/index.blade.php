...
@section('content')
  <x-toolbar title="Pembiayaan - Penerimaan" :breadcrumbs="[['label' => 'Home', 'url' => url('/')], ['label' => 'Pembiayaan'], ['label' => 'Penerimaan']]" />
    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
      ...
      <div class="card">
        <div class="card-header border-0 pt-6">
          <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
              ...
              <input type="text" data-kt-penerimaan-filter="search" class="form-control form-control-solid w-300px ps-12"
        ...
        <div class="card-body pt-0">
          <table id="kt_penerimaan_index_table" class="table align-middle table-row-dashed fs-6 gy-5">
            <thead>
  ...
  <script>
    ...
    var KTpenerimaanIndex = function() {
      var dt;
      ...
      var initDatatable = function() {
        dt = $('#kt_penerimaan_index_table').DataTable({
          searchDelay: 500,
          processing: true,
          serverSide: true,
          order: [
          ...
          language: {
            ...
            emptyTable: 'Tidak ada SKPD dengan pembiayaan penerimaan aktif',
          ...
          ajax: {
            url: "{{ route('pembiayaan.penerimaan.getData') }}",
            type: 'GET',
          ...
          columnDefs: [
            ...
            // Setelah perubahan + selisih
            {
              ...
              render: function(data, type, row) {
                ...
                var color = selisih >= 0 ? 'danger' : 'success'; // penerimaan: naik = bahaya
            ...
            // Aksi
            {
              ...
              className: 'text-end',
              render: function(data, type, row) {
                return `<a href="{{ url('pembiayaan/penerimaan') }}/${row.id_skpd}/rincian"
      ...
      var handleSearch = function() {
        const el = document.querySelector('[data-kt-penerimaan-filter="search"]');
