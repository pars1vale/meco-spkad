      ...
      <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
        <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
          <h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bold fs-3 m-0">
            Edit Data Pembiayaan Penerimaan
          </h1>
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
            ...
            <li class="breadcrumb-item text-muted">
              <a href="{{ route('pembiayaan.penerimaan.rincian', $id_skpd) }}" class="text-muted text-hover-primary">Rincian</a>
            </li>
            <li class="breadcrumb-item">
              <span class="bullet bg-gray-400 w-5px h-2px"></span>
            </li>
      ...
      <div class="card">
        ...
        <div class="card-header">
          ...
          <div class="card-toolbar">
            <a href="{{ route('pembiayaan.penerimaan.rincian', $id_skpd) }}" class="btn btn-secondary">
        ...
        {{-- Form --}}
        <form action="{{ route('pembiayaan.penerimaan.update', [$id_skpd, $pembiayaan->id]) }}" method="POST" class="form" id="form_edit_penerimaan">
          @csrf
          @method('PUT')
              ...
              <div class="col-md-6">
                ...
                <div class="fv-row mb-7">
                  ...
                  <textarea name="keterangan" id="input_keterangan_edit" class="form-control form-control-solid @error('keterangan') is-invalid @enderror"
                    rows="5" placeholder="Masukkan keterangan / uraian pembiayaan penerimaan...">{{ old('keterangan', $pembiayaan->keterangan) }}</textarea>
                  @error('keterangan')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                  <div class="form-text text-muted fs-7">
          ...
          <div class="card-footer bg-light">
            <div class="d-flex justify-content-end gap-2">
              <a href="{{ route('pembiayaan.penerimaan.rincian', $id_skpd) }}" class="btn btn-light">
                <i class="ki-outline ki-cross fs-2"></i>
                Batal
              </a>
              <button type="submit" class="btn btn-primary" id="btn_update_penerimaan">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (inputNilai) {
        ...
        var form = document.getElementById('form_edit_penerimaan');
        if (form) {
          form.addEventListener('submit', function() {
            inputNilai.value = toNumber(inputNilai.value);
            var btn = document.getElementById('btn_update_penerimaan');
            if (btn) {
