  ...
  <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
    <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
      <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
        <h1 class="page-heading text-dark fw-bold fs-3 m-0">Jadwal RKPD</h1>
                ...
                <th class="w-10px pe-2">
                  <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                    <input class="form-check-input" type="checkbox"
                           data-kt-check="true"
                           data-kt-check-target="#kt_jadwal_table .form-check-input" />
                  </div>
                </th>
                    ...
                    <div class="d-flex justify-content-end">
                      ...
                      <form action="{{ route('rkpd.jadwal-rkpd.destroy', $jadwal->id_jadwal) }}" method="POST" class="d-inline delete-form">
                        ...
                        <button type="submit"
                                ...
                                data-name="{{ $jadwal->subTahap->nama_sub_tahap ?? 'Jadwal' }}"
                                title="Hapus Jadwal">
