      ...
      <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
        <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
            ...
            <li class="breadcrumb-item text-muted">Jadwal RKPD</li>
          </ul>
        </div>
      </div>
    </div>
          ...
          @if ($data->isEmpty())
            <div class="alert alert-warning d-flex align-items-center p-5 rounded">
              ...
              <div class="d-flex flex-column">
                ...
                <span>Tidak ada data Jadwal RKPD yang ditemukan.</span>
              </div>
            </div>
          @else
            <table id="kt_akun_table" class="table table-striped align-middle table-row-dashed fs-6 gy-5">
              <thead>
                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                  ...
                  <th class="min-w-100px">Tahap</th>
                  <th class="min-w-300px">Sub Tahap</th>
                  <th class="min-w-130px">Status</th>
                  <th class="min-w-130px">Jadwal Mulai</th>
                  <th class="min-w-130px">Jadwal Selesai</th>
