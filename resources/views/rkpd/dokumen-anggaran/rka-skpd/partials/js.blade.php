<script>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    var modalEl = document.getElementById('modal-cetak-rka-skpd');
    ...
    document.querySelectorAll('.btn-cetak-rka-skpd').forEach(function(btn) {
    ...
    document.getElementById('btn-submit-cetak-rka-skpd').addEventListener('click', function() {
      ...
      var form = document.getElementById('form-cetak-rka-skpd');
