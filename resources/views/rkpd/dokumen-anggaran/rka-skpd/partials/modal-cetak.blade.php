<div class="modal fade" id="modal-cetak-rka-skpd" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Cetak Rincian RKA SKPD</h3>
        <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
          <i class="ki-duotone ki-cross fs-1"></i>
        </div>
      </div>
      <div class="modal-body">
        <form id="form-cetak-rka-skpd" data-url-cetak-base="{{ url('rkpd/dokumen-anggaran/rka-skpd') }}">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="btn-submit-cetak-rka-skpd">Cetak</button>
      </div>
    </div>
  </div>
</div>
