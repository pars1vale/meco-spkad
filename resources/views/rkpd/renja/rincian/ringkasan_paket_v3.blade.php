...
<body>
  <div class="page">
    ...
    {{-- ══ SUBHEADER ══ --}}
    @php
      $tahunAnggaran = $subKegiatan->tahun_anggaran ?? 2025;
    @endphp
    <div class="doc-subheader">
      Pemerintahan {{ $subKegiatan->nama_daerah ?? 'Kab. Yahukimo' }} Tahun Anggaran {{ $tahunAnggaran }}
    </div>
